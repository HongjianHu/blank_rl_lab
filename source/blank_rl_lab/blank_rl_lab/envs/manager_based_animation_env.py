...
from blank_rl_lab.managers import AnimationManager, MotionDataManager
...
class ManagerBasedAnimationEnv(ManagerBasedRLEnv):
    ...
    def _reset_idx(self, env_ids: Sequence[int]):
        ...
        # Apply reference state initialization after Isaac Lab reset events, so
        # reset_base/reset_robot_joints cannot overwrite the AMP pose.
